import{i as m,s as O,x as u}from"./lit-element-8d145624.js";import{e as S}from"./class-map-10d9f55a.js";import{o as f}from"./if-defined-64006850.js";import{n as r,t as z}from"./property-c8c6de82.js";import{e as q}from"./query-2518e02e.js";import"./component-cd18fe0b.js";const B=m`
  :host {
...
`;var k=Object.defineProperty,I=Object.getOwnPropertyDescriptor,t=(a,n,p,l)=>{for(var i=l>1?void 0:l?I(n,p):n,d=a.length-1,o;d>=0;d--)(o=a[d])&&(i=(l?o(n,p,i):o(i))||i);return l&&i&&k(n,p,i),i},g=(a=>(a.Small="small",a.Medium="medium",a))(g||{});let e=class extends O{constructor(){super(...arguments),this._value="",this.disabled=!1,this.hiddenLabel=!1,this.inputType="text",this.readOnly=!1,this.required=!1,this.pattern=void 0,this.placeholder=void 0,this.value=void 0,this.iconBefore=void 0,this.iconAfter=void 0}_handleInput({target:a}){this.value=a.value}render(){const{disabled:a,hiddenLabel:n,inputType:p,label:l,readOnly:i,value:d,iconBefore:o,iconAfter:c,pattern:$,placeholder:x,required:y,_handleInput:_}=this,w=S({"input--label":!0,required:y,"sr-only":n});return u`
...
}`,...(h=(v=s.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};const E=["Default"];export{s as Default,E as __namedExportsOrder,j as default};
//# sourceMappingURL=component.stories-3b0ba0e6.js.map
